...
public class NightBorneGroundState : NightBorneStates
{
    protected Transform playerTransform;

    public NightBorneGroundState(Enemy _enemyBase, IEnemyStateMachine _StateMachine, string _animBoolName, Enemy_NightBorne _enemy) : base(_enemyBase, _StateMachine, _animBoolName, _enemy)
    {
    }
