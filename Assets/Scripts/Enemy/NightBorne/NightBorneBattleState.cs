...
public class NightBorneBattleState : NightBorneStates
{
    private Transform player;
    private int moveDir;

    public NightBorneBattleState(Enemy _enemyBase, IEnemyStateMachine _StateMachine, string _animBoolName, Enemy_NightBorne _enemy) : base(_enemyBase, _StateMachine, _animBoolName, _enemy)
    {
    }
    ...
    public override void Enter()
    {
        ...
        {
            enemy.nightBorneStateFactory.ChangeNightBorneState(enemy.moveState);
        }
    }
    ...
    public override void Update()
    {
        ...
        if (enemy.IsPlayerDetected())
        {
            ...
            if (enemy.IsPlayerDetected().distance <= enemy.attackDistance)
            {
                if (CanAttack())
                {
                    enemy.nightBorneStateFactory.ChangeNightBorneState(enemy.attackState);
                }
            }
        }
        else
